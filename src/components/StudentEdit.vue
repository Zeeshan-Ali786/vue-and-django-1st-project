    ...
    <div>
        <v-row>
            <v-col cols="10" offset-md="1">
                <v-form>
                    <v-text-field id="first_name" label="First Name" placeholder="First Name" :counter="15" v-model="localStudent.first_name" ></v-text-field>
                    <v-text-field  id="last_name" label="Lat Name" placeholder="Last Name" :counter="15"  v-model="localStudent.last_name" ></v-text-field>
                    ...
                    <v-row>
                            <v-col cols="6" offset-md="6" :style="{'text-align':'right'}">
                                <v-btn color="success" type="button" elevation="2" @click="onSubmit()">Submit</v-btn>
                            </v-col>
                    </v-row>
                </v-form>
            </v-col>
    ...
    methods:{
        onSubmit(){
            if(this.student.id){
                ...
                body: JSON.stringify({first_name: this.localStudent.first_name, last_name: this.localStudent.last_name, 
